...
- sampling: :func:`~sempler.NormalDistribution.sample`
- least-squares regression in the "population setting": :func:`~sempler.NormalDistribution.regress` and :func:`~sempler.NormalDistribution.mse`
